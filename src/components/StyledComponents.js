...
export const PatientIcon = styled.span`
  ${'' /* display: inline-block; */} color: #fffdde;
  width: 50px;
  height: 50px;
  margin: auto;
  padding: 0 0 10px 0;
...
export const PersonCardSty = styled.div`
  border-color: ${props =>
    props.focused ? 'rgba(0, 0, 0, 0.5)' : 'rgba(0, 0, 0, 0)'};
  width:40%;
  margin: auto;
  height:100%;
  background: #608796;
 ...
 &:hover {
   border-color: ${props =>
     props.focused ? 'rgba(0, 0, 0, 0.5)' : 'rgba(0, 0, 0, .2)'};
 }
`;
...
export const ButtonGroup = styled.div`
  ${'' /* display:flex;
  justify-content:space-evenly; */} max-width: 150px;
  order: 2;
  @media (max-width: ${breakpoint1}) {
...
export const ResultPageFlex = styled.div`
  ...
  ${'' /* height:300px; */} flex-wrap: wrap;
`;

export const BadgeContainer = styled.div`
  margin: auto;
  width: 120px;
  ${'' /* height:60px; */} background: rgb(70,70,70);
  color: #eee;
  display: flex;
  flex-direction: column;
  padding: 10px 15px;
...
export const ExpCard = styled.div`
  ...
  ${'' /* background: #608796; */} ${'' /* padding: 10px;
  border-radius: 5px;
  box-shadow: 0 2px 2px 0 rgba(0, 0, 0, 0.14),
             0 1px 5px 0 rgba(0, 0, 0, 0.12),
             0 3px 1px -2px rgba(0, 0, 0, 0.2); */}
...
export const ResultTableCell = styled.td`
  ${'' /* border: .5px solid #fffdde; */} padding: 10px 5px;
  color: #fffdde;
